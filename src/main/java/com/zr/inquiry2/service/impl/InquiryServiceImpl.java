package com.zr.inquiry2.service.impl;

import com.zr.feignproxy.FeignProxy;
...
//        List<InquiryParts> inquiryPartsList = inquiryMapper.queryByPartCodes(partCodeList);
        ...
        //跨服务到基础数据服务中，查询备件信息是否存在
        List<InquiryParts> inquiryPartsList = feignProxy.queryByPartCodes(partCodeList);
